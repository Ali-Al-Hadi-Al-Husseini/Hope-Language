...
TOKEN_MODULE       = 'MOD'
TOKEN_PLUS_EQUAL   = 'PLUSEQUAL'
TOKEN_MINUS_EQUAL  = 'MINUSEQUAL'
TOKEN_MUL_EQUAL    = 'MULEQUAL'
TOKEN_DIV_EQUAL    = 'DIVEQUAL'
TOKEN_POW_EQUAL    = 'POWEQUAL'
TOKEN_MODULE_EQUAL = 'MODEQUAL'
TOKEN_LPAREN       = 'LPAREN'
