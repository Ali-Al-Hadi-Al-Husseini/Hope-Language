...
class TestTokenizer(unittest.TestCase):
    def setUp(self) -> None:
        self.tokenizer_test_cases_success = [
                ...
                ('((9 / 3)  * 0 )', ['LPAREN', 'LPAREN', 'INTEGER:9', 'DIV', 'INTEGER:3', 'RPAREN', 'MUL', 'INTEGER:0', 'RPAREN', 'EOF']),
                ('((9 / 3) / 0 )', ['LPAREN', 'LPAREN', 'INTEGER:9', 'DIV', 'INTEGER:3', 'RPAREN', 'DIV', 'INTEGER:0', 'RPAREN', 'EOF']),
                ...
                ('let i = 0\n        while i < 5 >> i +=  1\n        print(i)\n        ', ['KEYWORD:let', 'IDENTIFIER:i', 'EQ', 'INTEGER:0', 'NEWLINE', 'KEYWORD:while', 'IDENTIFIER:i', 'LT', 'INTEGER:5', 'UNTIL', 'IDENTIFIER:i', 'EQ', 'IDENTIFIER:i', 'PLUS', 'INTEGER:1', 'NEWLINE', 'IDENTIFIER:print', 'LPAREN', 'IDENTIFIER:i', 'RPAREN', 'NEWLINE', 'EOF']),
                ('let i = 0\n        while i < 10 >> \n            i +=  1\n            if i == 5  >> break\n        <<\n        print(i)\n        ', ['KEYWORD:let', 'IDENTIFIER:i', 'EQ', 'INTEGER:0', 'NEWLINE', 'KEYWORD:while', 'IDENTIFIER:i', 'LT', 'INTEGER:10', 'UNTIL', 'NEWLINE', 'IDENTIFIER:i', 'EQ', 'IDENTIFIER:i', 'PLUS', 'INTEGER:1', 'NEWLINE', 'KEYWORD:if', 'IDENTIFIER:i', 'EE', 'INTEGER:5', 'UNTIL', 'KEYWORD:break', 'NEWLINE', 'SKIP', 'NEWLINE', 'IDENTIFIER:print', 'LPAREN', 'IDENTIFIER:i', 'RPAREN', 'NEWLINE', 'EOF']),
                ...
                ('let i=0\n        while i < 5 >>\n            print(i) \n            i = 1 + i \n        <<\n        print(i == 4)\n        ', ['KEYWORD:let', 'IDENTIFIER:i', 'EQ', 'INTEGER:0', 'NEWLINE', 'KEYWORD:while', 'IDENTIFIER:i', 'LT', 'INTEGER:5', 'UNTIL', 'NEWLINE', 'IDENTIFIER:print', 'LPAREN', 'IDENTIFIER:i', 'RPAREN', 'NEWLINE', 'IDENTIFIER:i', 'EQ', 'INTEGER:1', 'PLUS', 'IDENTIFIER:i', 'NEWLINE', 'SKIP', 'NEWLINE', 'IDENTIFIER:print', 'LPAREN', 'IDENTIFIER:i', 'EE', 'INTEGER:4', 'RPAREN', 'NEWLINE', 'EOF']),
                ('let x = 0; print(x+1)', ['KEYWORD:let', 'IDENTIFIER:x', 'EQ', 'INTEGER:0', 'NEWLINE', 'IDENTIFIER:print', 'LPAREN', 'IDENTIFIER:x', 'PLUS', 'INTEGER:1', 'RPAREN', 'EOF']),
